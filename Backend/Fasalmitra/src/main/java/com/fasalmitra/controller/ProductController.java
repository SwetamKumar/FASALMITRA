...
import com.fasalmitra.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<ApiResponse<List<ProductResponse>>> getProducts(
        ...
        return ResponseEntity.ok(ApiResponse.success(
            productService.filterProducts(category, minPrice, maxPrice, search)));
    }
    ...
    public ResponseEntity<ApiResponse<ProductResponse>> addProduct(
        ...
        return ResponseEntity.ok(
            ApiResponse.success("Product added", productService.addProduct(request)));
    }
    ...
    public ResponseEntity<ApiResponse<List<ProductResponse>>> getMyProducts() {
        return ResponseEntity.ok(ApiResponse.success(productService.getMyProducts()));
    }
}
